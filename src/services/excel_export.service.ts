...
import { ExcelDataAggregationService } from './excel_data_aggregation.service';
import type { AggregatedExcelDataDTO } from './excel_data_aggregation.service';
...
export const ExcelExportService = {
    async exportMRVExcel(voyageId: string): Promise<Buffer> {
        ...
        const data: AggregatedExcelDataDTO = await ExcelDataAggregationService.aggregateDataForExcel(voyageId);
        ...
        worksheet.getColumn('AW').width = 12; worksheet.getColumn('AX').width = 15; worksheet.getColumn('AY').width = 15;
        worksheet.getColumn('AZ').width = 15; worksheet.getColumn('BA').width = 20;
        worksheet.getColumn('BB').width = 15; worksheet.getColumn('BC').width = 20; worksheet.getColumn('BD').width = 20;
        ...
        worksheet.getCell('BF7').value = 'Guidance on Cargo Units Selection'; worksheet.mergeCells('BF7:BM7');
        worksheet.getCell('BO7').value = 'Type of Ship'; worksheet.getCell('BP7').value = 'Cargo Units'; worksheet.mergeCells('BO7:BV7'); 
        ...
        worksheet.getCell('AW8').value = '(hh:mm)'; worksheet.getCell('AX8').value = 'Travelled (NM)'; worksheet.getCell('AY8').value = '(knots)';
