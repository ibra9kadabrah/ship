...
function setupDatabase() {
  ...
  `);
    ...
    try {
        connection_1.default.exec(`ALTER TABLE reports ADD COLUMN berthNumber TEXT NULL`);
    ...
    try {
        connection_1.default.exec(`ALTER TABLE reports ADD COLUMN modification_checklist TEXT NULL`);
    ...
    try {
        connection_1.default.exec(`ALTER TABLE reports ADD COLUMN requested_changes_comment TEXT NULL`);
