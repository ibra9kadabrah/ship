...
exports.VoyageService = {
     ...
     */
    async getCurrentVoyageState(vesselId) {
        // Get the absolute latest report for the vessel
        const latestReport = report_model_1.default.getLatestReportForVessel(vesselId);
        if (!latestReport) {
        ...
        if (latestReport.voyageId) {
            const voyage = voyage_model_1.default.findById(latestReport.voyageId);
     ...
     */
    async getCarryOverCargoDetails(vesselId) {
        ...
        const latestApprovedEndReport = report_model_1.default.getLatestApprovedArrivalOrBerthReport(vesselId);
        if (latestApprovedEndReport) {
            ...
            const reportData = latestApprovedEndReport; // Cast to access potential cargo fields
            ...
            const cargoStatus = cargoQuantity > 0 ? 'Loaded' : 'Empty';
...
exports.default = exports.VoyageService;
